...
NREUM.loader_config = {
  ...
  trustKey: "7984447",
  agentID: "1134685271",
  licenseKey: "NRJS-b052ebd5aa5bc9596f7",
  applicationID: "1134685271",
};
NREUM.info = {
  ...
  applicationID: "1134685271",
  sa: 1,
}; /*! For license information please see nr-loader-spa-1.313.1.min.js.LICENSE.txt */
(() => {
  var e,
    t,
    r = {
          ...
          f = (e) =>
            (0, u.a)(
              ...
              (() => {
                const e = {
                  feature_flags: [],
                  experimental: { register: !1, resources: !1 },
                  mask_selector: "*",
      ...
      5732: (e, t, r) => {
        ...
        function c(e, t) {
          return (
            !!e &&
            !!u(t) &&
            t.agentRef.init.api.register.duplicate_data_to_container
          );
        }
        function d(e) {
      ...
      7508: (e, t, r) => {
            ...
            e.forEach((e) => {
              e.addedNodes.forEach((e) => {
                if ("SCRIPT" === e.nodeName && e.src) {
                  ...
                  ["load", "error"].forEach((t) =>
                    e.addEventListener(t, r, { once: !0 }),
                  );
                }
              });
            });
          }).observe(n.gm.document, { childList: !0, subtree: !0 });
        }
        if (
        ...
        function b() {
          ...
          try {
            ...
            e.correlation = h(a);
            const c =
              e.correlation?.performance.value ||
              performance.getEntriesByType("resource").find((e) => v(e, a));
            (c
              ? y(e, c)
              : (function (e) {
  ...
  ((i.m = r),
    ...
    (i.l = (r, n, s, o) => {
      if (e[r]) e[r].push(n);
        ...
        if (!a) {
          c = !0;
          var f = {
            478: "sha512-/9l9ZhNQoyI1Aj0GOsHHrbCo/rjGQPYuKrz+qTo7jMK0J2ZChW9rZIzC4rWZ3aDprAyy3ORdgy+LpBQTK97JQQ==",
            249: "sha512-a/Apw1AGPQLoLS3GcBGmuJMcF53T8GoREi+bouJiiUCw+tTH9GfJrNLU6xN83ClwBg3O+ZUMtOQ0j7kFOIs0Kg==",
            212: "sha512-2GhRYmZ19Tul2VVrSHZ5+Si0FDRyXu+4jsuNCPf+ui6g0gqwE3lgchmNA9bHOPs9IQ0gLUC1p48MDuV2lCGI2g==",
          };
    ...
    (() => {
      ...
      var t = (t, r) => {
        ...
        r = (self["webpackChunk:NRBA-1.313.1.PROD"] =
          self["webpackChunk:NRBA-1.313.1.PROD"] || []);
    ...
    (() => {
      ...
      const Z = ["name", "id", "type"],
        ...
        X = {
          experimental: (0, m.J)(() => (0, h.R)(54, "newrelic.register")),
          disabled: (0, m.J)(() => (0, h.R)(55)),
          invalidTarget: (0, m.J)((e) => (0, h.R)(48, e)),
          deregistered: (0, m.J)(() => (0, h.R)(68)),
        };
      function Q(e) {
        (0, c.Y)(
          a.eY,
      ...
      function J(e, r) {
        ...
        const n = (0, G.Qr)(),
          i = {};
        (Object.prototype.hasOwnProperty.call(r, "attributes") ||
          ...
          Object.entries(r.tags).forEach(([e, t]) => {
            Z.includes(e) || (i["source.".concat(e)] = t);
          }));
        let a = () => {};
        ...
        (e.init.api.register.enabled || d(X.disabled),
          (u(r.id) && u(r.name)) || d(() => X.invalidTarget(r)));
        const l = {
            addPageAction: (t, n = {}) => m(U, [t, { ...i, ...n }, e], r),
            deregister: () => {
              (p(), d(X.deregistered));
            },
            log: (t, n = {}) =>
            ...
            noticeError: (t, n = {}) => m(B, [t, { ...i, ...n }, e], r),
            recordCustomEvent: (t, n = {}) => m(z, [t, { ...i, ...n }, e], r),
      ...
      class ee extends y {
        ...
        constructor(e) {
          ...
          (this.ee.on("internal-error", (t, r) => {
            ...
            this.importAggregator(e, () => i.e(478).then(i.bind(i, 9377))));
        }
        #r() {
      ...
      function ue(e, t) {
        ...
        if (
          ...
          i.inPlace(p.prototype, de, "-xhr-", w),
      ...
      function ye(e, t) {
        ...
        if (!(pe && ge && f.gm.fetch)) return r;
        if (ve[r.debugId]++) return r;
        function n(e, n, i) {
          var s = e[n];
          "function" == typeof s &&
            (e[n] = function () {
        ...
        return (
          (ve[r.debugId] = 1),
          he.forEach((e) => {
            (n(pe[me], e, fe), n(ge[me], e, fe));
          }),
          n(f.gm, "fetch", le),
          r.on(le + "end", function (e, t, n) {
            var i = this;
            if (((i.targets = n || [void 0]), t)) {
              var s = t.headers.get("content-length");
              (null !== s && (i.rxSize = s), r.emit(le + "done", [null, t], i));
            } else r.emit(le + "done", [e], i);
          }),
          r
        );
      }
      ...
      class we {
        ...
        generateTraceHeader(e, t, r, n, i, s) {
          ...
          return (s && n !== s && (o.d.tk = s), btoa((0, j.A)(o)));
        }
        ...
        isAllowedOrigin(e) {
          ...
          if (e.sameOrigin) t = !0;
            ...
            for (var n = 0; n < r.allowed_origins.length; n++) {
              var i = (0, be.D)(r.allowed_origins[n]);
              if (
      ...
      var Ae = ["load", "error", "abort", "timeout"],
        xe = Ae.length,
        Se = (0, T.dV)().o.REQ,
        _e = (0, T.dV)().o.XHR;
      const Oe = "X-NewRelic-App-Data";
      class Pe extends y {
          ...
          (ye(this.ee, e),
            ...
            (function (e, r, n, i) {
              ...
              function u(e, t) {
                ...
                for (var c = 0; c < xe; c++)
                  t.addEventListener(Ae[c], this.listener, (0, N.jT)(!1));
              }
              function l(e, t, r) {
                ((this.cbTime += e),
              ...
              function R(e, t) {
                ...
                ke(this, Te(r));
                const i = (
                  "" + ((r && r instanceof Se && r.method) || n.method || "GET")
                ).toUpperCase();
                ((this.params.method = i),
                  (this.body = n.body),
                  (this.txSize = ie(n.body) || 0));
              }
              function E(e, t) {
                if (
                  ((this.endTime = (0, o.t)()),
              ...
              function T(e) {
                ...
                this.ended = !0;
                for (let t = 0; t < xe; t++)
                  e.removeEventListener(Ae[t], this.listener, !1);
                if (t.aborted) return;
                if ((0, Ee.iW)(t)) return;
              ...
              function x(e, n) {
                ...
                if (
                  ...
                  e.sameOrigin && n.getAllResponseHeaders().indexOf(Oe) >= 0)
                ) {
                  var o = n.getResponseHeader(Oe);
                  o &&
                    ((0, s.p)(
                      O.rs,
      ...
      function De(e) {
        ...
        return (
          !f.RI ||
            Ne[t.debugId]++ ||
            ((Ne[t.debugId] = 1),
            (0, ae.YM)(t).inPlace(window.history, je, "-")),
          t
        );
      }
      var Ce = i(3738);
      ...
      class Ve extends y {
        ...
        constructor(e) {
          ...
          let d;
          (De(n),
            (this.eventsEE = (0, se.u)(n)),
            this.eventsEE.on(Fe, function (e, t) {
              this.bstStart = (0, o.t)();
            }),
            this.eventsEE.on(We, function (e, r) {
              (0, s.p)(
                "bst",
            ...
            n.on(Ue + Be, function (e) {
              ((this.time = (0, o.t)()),
                (this.startPath = location.pathname + location.hash));
            }),
            n.on(Ue + He, function (e) {
              (0, s.p)(
                "bstHist",
          ...
          try {
            ((d = new PerformanceObserver((e) => {
              ...
              (0, s.p)(Ie, [r], void 0, t.K7.sessionTrace, n);
            })),
              d.observe({ type: Me, buffered: !0 }));
          } catch (e) {}
          ...
          ((0, p.SR)(e.init) && this.ee.on(a.CH, () => this.#i()),
            this.#s(n) &&
              this.importRecorder().then((e) => {
                e.startRecording(ze.Qb.PRELOAD, n?.sessionReplayMode);
              }),
            ...
            this.ee.on("err", (e) => {
              this.blocked ||
                (this.agentRef.runtime.isRecording &&
                  ((this.errorNoticed = !0),
                  (0, s.p)(ze.Vh, [e], void 0, this.featureName, this.ee)));
            }));
        }
        #s(e) {
          return (
          ...
          this.blocked ||
            (this.featAggregate
              ? this.featAggregate.mode !== w.g.FULL &&
                this.featAggregate.initializeRecording(w.g.FULL, !0, ze.Qb.API)
              : this.importRecorder().then(() => {
                  this.recorder.startRecording(ze.Qb.API, w.g.FULL);
                }));
        }
      }
      var Ye = i(3962);
      ...
      class et {
        constructor(e, t) {
          ((this.timestamp = (0, o.t)()),
            (this.currentUrl = (0, Xe.L)(window.location.href)),
            (this.socketId = (0, Y.LA)(8)),
            (this.requestedUrl = (0, Xe.L)(e)),
      ...
      class tt extends y {
        static featureName = qe.TZ;
        constructor(e) {
          super(e, qe.TZ);
          const r = e.init.feature_flags.includes("websockets"),
            n = !e.init.feature_flags.includes("no_spv"),
            d = [
          ...
          if (
            ((u = e),
            (0, c.Y)(a.hG, (e, t) => U(e, t, u), u),
            (function (e) {
              (0, c.Y)(a.fF, (t, r) => z(t, r, e), e);
            })(e),
            Le(e),
            Q(e),
            (function (e) {
                ...
                constructor(...e) {
                  (super(...e),
                    ...
                    this.addEventListener("message", (e) => {
                      const { type: t, size: r } = Je(e.data);
                      ((this.nrData.messageOrigin ??= (0, Xe.L)(e.origin)),
                        ...
                        (this.nrData.messageTypes ?? "").includes(t) ||
                          (this.nrData.messageTypes = this.nrData.messageTypes
                            ? "".concat(this.nrData.messageTypes, ",").concat(t)
                            : t));
                    }),
          ...
          if (
            (n &&
              f.gm.addEventListener(
                ...
                (e) => {
                  (0, s.p)("spv", [e], void 0, t.K7.genericEvents, this.ee);
                },
                (0, N.jT)(!1, this.removeOnAbort.signal),
              ),
            f.RI)
            ...
            if (
              ...
              (qe.Zp.forEach((e) =>
                ...
                this.ee.on("open-xhr-start", (e, r) => {
                  p(e[1]) ||
                    r.addEventListener(
                      ...
                      (0, N.jT)(void 0, this.removeOnAbort.signal),
                    );
                }),
                ...
                l.on("pushState-end", g),
                l.on("replaceState-end", g),
      ...
      function it(e, t, r, n, i = !0, s) {
        if (
          ...
          return (0, h.R)(29);
        const o = (function (e) {
            return (e || oe.ee).get("logger");
          })(e),
          a = (0, ae.YM)(o, void 0, s),
          c = new rt.y(oe.P);
        ((c.level = n.level),
          (c.customAttributes = n.customAttributes),
          (c.autoCaptured = i));
        const d = t[r]?.[ae.Jt] || t[r];
        return (
          nt.set(d, c),
          a.inPlace(t, [r], "wrap-logger-", () => nt.get(d), void 0, !0),
          o
        );
      }
      var st = i(1910);
            ...
            (function (e) {
              (0, c.Y)(
                ...
                (
                  ...
                  it(e.ee, t, r, { customAttributes: n, level: i }, !1, e);
                },
                e,
              );
            })(e),
      ...
      new A({
        features: [Pe, E, _, Ve, Ge, P, ee, tt, ot, Ze],
        loaderType: "spa",
      });
    })());
})();
